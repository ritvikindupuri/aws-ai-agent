  ...
  public: {
    Tables: {
      ...
      compliance_attestations: {
        ...
        Relationships: [
          {
            foreignKeyName: "compliance_attestations_latest_export_id_fkey"
            columns: ["latest_export_id"]
            isOneToOne: false
            referencedRelation: "compliance_evidence_exports"
            referencedColumns: ["id"]
          },
        ]
      }
      compliance_exceptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "compliance_exceptions_evidence_export_id_fkey"
